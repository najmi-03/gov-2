    ...
    >
      <div className="h-56 overflow-hidden relative">
        ...
        <div className="absolute top-4 right-4">
          <span className="text-[9px] font-bold text-amber-500 uppercase tracking-widest bg-slate-950/80 backdrop-blur-md px-3 py-1 rounded-full border border-amber-500/20">
            {news.tag}
          </span>
        </div>
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          <span className="text-[10px] font-bold text-amber-500 uppercase tracking-widest">Detail Informasi</span>
